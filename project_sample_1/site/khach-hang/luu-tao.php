...
if($ma_khErr.$nameErr.$emailErr.$passwordErr.$cfpasswordErr.$avatarErr.$phone_numberErr.$ngay_sinhErr.$cau_hoiErr != ""){
    header('location: ' . BASE_URL_B . "site/khach-hang/register.php?ma_kherr=$ma_khErr&nameerr=$nameErr&emailerr=$emailErr&passworderr=$passwordErr&cfpassworderr=$cfpasswordErr&avatarerr=$avatarErr&phone_numbererr=$phone_numberErr&ngay_sinherr=$ngay_sinhErr&cauhoierr=$cau_hoiErr");
    die;
}
// mã hóa mật khẩu
...
header("location: " . BASE_URL_11 . "?msg=Tạo tài khoản thành công mời đăng nhập");
?>